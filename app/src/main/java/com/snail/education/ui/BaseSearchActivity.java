...
//                if (BaseSearchActivity.this instanceof MWTSearchActivity) {
//                    ((MWTSearchActivity) BaseSearchActivity.this).performSearch(keyword);
//                } else {
...
//                }
    ...
    private void customizeSearchView(SearchView searchView) {
        int themeColor = SEThemer.getInstance().getActionBarForegroundColor();
        ...
        try {
            ...
            searchIcon.setIconColor(SEThemer.getInstance().getActionBarBackgroundColor());
